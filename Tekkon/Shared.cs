...
/* 取消合併專案 'Tekkon(net6.0)' 的變更
之前:
  public readonly static string[][] ArrPhonaToHanyuPinyin = {
    new[] { " ", "1" },           new[] { "ˊ", "2" },
    new[] { "ˇ", "3" },           new[] { "ˋ", "4" },
    new[] { "˙", "5" },           new[] { "ㄅㄧㄝ", "bie" },
  ...
  /// </summary>
  public readonly static string[][] ArrHanyuPinyinTextbookStyleConversionTable =
之後:
...
之前:
  public readonly static Dictionary<string, string> MapArayuruPinyinIntonation =
      new Dictionary<string, string> { ["1"] = " ", ["2"] = "ˊ", ["3"] = "ˇ",
                                       ["4"] = "ˋ", ["5"] = "˙", ["6"] = "ˊ",
                                       ["7"] = "˙", [" "] = " " };
  ...
  /// 漢語拼音排列專用處理陣列
  /// </summary>
  public readonly static Dictionary<string, string> MapHanyuPinyin =
  ...
  /// 國音二式排列專用處理陣列
  /// </summary>
  public readonly static Dictionary<string, string> MapSecondaryPinyin =
      new Dictionary<string, string> {
  ...
  /// 耶魯拼音排列專用處理陣列
  /// </summary>
  public readonly static Dictionary<string, string> MapYalePinyin =
      new Dictionary<string, string> {
  ...
  /// 華羅拼音排列專用處理陣列
  /// </summary>
  public readonly static Dictionary<string, string> MapHualuoPinyin =
      new Dictionary<string, string> {
  ...
  /// 通用拼音排列專用處理陣列
  /// </summary>
  public readonly static Dictionary<string, string> MapUniversalPinyin =
      new Dictionary<string, string> {
  ...
  /// 韋氏拼音排列專用處理陣列
  /// </summary>
  public readonly static Dictionary<string, string> MapWadeGilesPinyin =
      new Dictionary<string, string> {
        ["a"] = "ㄚ",           ["ai"] = "ㄞ",         ["an"] = "ㄢ",
        ["ang"] = "ㄤ",         ["ao"] = "ㄠ",         ["cha"] = "ㄓㄚ",
  ...
  public readonly static Dictionary<string, string> MapDachenCp26StaticKeys =
      new Dictionary<string, string> { ["a"] = "ㄇ", ["b"] = "ㄖ",
                                       ["c"] = "ㄏ", ["d"] = "ㄎ",
                                       ["e"] = "ㄍ", ["f"] = "ㄑ",
                                       ["g"] = "ㄕ", ["h"] = "ㄘ",
                                       ["i"] = "ㄞ", ["j"] = "ㄨ",
  ...
  public readonly static Dictionary<string, string> MapHsuStaticKeys =
      new Dictionary<string, string> { ["a"] = "ㄘ", ["b"] = "ㄅ", ["c"] = "ㄕ",
                                       ["d"] = "ㄉ", ["e"] = "ㄧ", ["f"] = "ㄈ",
                                       ["g"] = "ㄍ", ["h"] = "ㄏ", ["i"] = "ㄞ",
                                       ["j"] = "ㄐ", ["k"] = "ㄎ", ["l"] = "ㄌ",
                                       ["m"] = "ㄇ", ["n"] = "ㄋ", ["o"] = "ㄡ",
  ...
  public readonly static Dictionary<string, string> MapETen26StaticKeys =
      new Dictionary<string, string> { ["a"] = "ㄚ", ["b"] = "ㄅ",
                                       ["c"] = "ㄕ", ["d"] = "ㄉ",
                                       ["e"] = "ㄧ", ["f"] = "ㄈ",
                                       ["g"] = "ㄓ", ["h"] = "ㄏ",
                                       ["i"] = "ㄞ", ["j"] = "ㄖ",
  ...
  public readonly static Dictionary<string, string> MapStarlightStaticKeys =
      new Dictionary<string, string> { ["a"] = "ㄚ", ["b"] = "ㄅ", ["c"] = "ㄘ",
                                       ["d"] = "ㄉ", ["e"] = "ㄜ", ["f"] = "ㄈ",
                                       ["g"] = "ㄍ", ["h"] = "ㄏ", ["i"] = "ㄧ",
                                       ["j"] = "ㄓ", ["k"] = "ㄎ", ["l"] = "ㄌ",
                                       ["m"] = "ㄇ", ["n"] = "ㄋ", ["o"] = "ㄛ",
  ...
  public readonly static Dictionary<string, string> MapAlvinLiuStaticKeys =
      new Dictionary<string, string> { ["q"] = "ㄑ", ["w"] = "ㄠ",
                                       ["e"] = "ㄜ", ["r"] = "ㄖ",
                                       ["t"] = "ㄊ", ["y"] = "ㄩ",
                                       ["u"] = "ㄨ", ["i"] = "ㄧ",
                                       ["o"] = "ㄛ", ["p"] = "ㄆ",
  ...
  /// 精業排列專用處理陣列。
  /// </summary>
  public readonly static Dictionary<string, string> MapSeigyou = new Dictionary<
      string, string> { ["a"] = "ˇ",  ["b"] = "ㄒ", ["c"] = "ㄌ", ["d"] = "ㄋ",
                        ["e"] = "ㄊ", ["f"] = "ㄎ", ["g"] = "ㄑ", ["h"] = "ㄕ",
                        ["i"] = "ㄛ", ["j"] = "ㄘ", ["k"] = "ㄜ", ["l"] = "ㄠ",
                        ["m"] = "ㄙ", ["n"] = "ㄖ", ["o"] = "ㄟ", ["p"] = "ㄣ",
                        ["q"] = "ˊ",  ["r"] = "ㄍ", ["s"] = "ㄇ", ["t"] = "ㄐ",
